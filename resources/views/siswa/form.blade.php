...
@section('contents')
    <div class="col-12 col-md-8 col-lg-6 offset-md-2 offset-lg-3">
        ...
        @if (Request()->is('siswa/create'))
            <form action="{{ route('siswa.store') }}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nis" id="nis" pattern="[0-9]+"
                                ...
                                <div class="col-auto">
                                    <div class="form-check">
                                        <input type="radio" name="jk" id="lk" value="Laki-laki"
                                            ...
                                            @checked(old('jk') === 'Laki-laki') required>
                                ...
                                <div class="col-auto">
                                    <div class="form-check">
                                        <input type="radio" name="jk" id="pr" value="Perempuan"
                                            class="form-check-input @error('jk') is-invalid @enderror"
                                            @checked(old('jk') === 'Perempuan') required>
                        ...
                        <div class="form-group mb-3">
                            <label for="nama" class="form-label">Profile Siswa</label>
        ...
        @else
            <form action="{{ route('siswa.save.update', $siswa->id) }}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="card">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nis" id="nis" pattern="[0-9]+"
                                ...
                                value="{{ old('nis', $siswa->nis) }}" readonly required>
                            @error('nis')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="row gx-5">
                                <div class="col-auto">
                                    <div class="form-check">
                                        <input type="radio" name="jk" id="lk" value="Laki-laki"
                                            class="form-check-input @error('jk') is-invalid @enderror"
                                            @checked(old('jk', $siswa->jk) === 'Laki-laki') required>
                                        <label for="lk" class="form-check-label">Laki-laki</label>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="form-check">
                                        <input type="radio" name="jk" id="pr" value="Perempuan"
                                            class="form-check-input @error('jk') is-invalid @enderror"
                                            @checked(old('jk', $siswa->jk) === 'Perempuan') required>
                                        <label for="pr" class="form-check-label">Perempuan</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group mb-3">
                            <label for="gambar" class="form-control">Profile Siswa</label>
                            <input type="file" name="gambar" id="gambar"
                                class="form-control @error('gambar') is-invalid @enderror" value="{{ old('gambar') }}"
                                >
                            @error('gambar')
