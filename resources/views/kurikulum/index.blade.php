        ...
        <div class="card-header">
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
              ...
              <a href="#form-add" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="form-add" class="btn btn-sm btn-primary"><i class="bi bi-person-plus"></i> Tambah Data Kurikulum</a>
            </div>
          </div>
        </div>
        <div class="card-body">
                ...
                @foreach ($kurikulum as $item)
                  <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="{{ route('kurikulum.update', $item->id) }}" class="btn btn-sm btn-outline-warning"><i class="bi bi-pencil-square"></i></a>
